...
function createIcon(status) {
  ...
  icon.image = "/static/piplmesh/images/status_" + status + "_gmap.png";
  icon.shadow = "/static/piplmesh/images/gmap_node_shadow.png";
  icon.transparent = "/static/piplmesh/images/gmap_node_transparent.png";
...
function createMarker(node) {
  ...
  GEvent.addListener(m, "click", function() {
    html = "<b>Node " + node.name + "</b><div class=\"gmap_details\">Status: <span class=\"node_status_" +
           node.status + "\">" + node.status + "</span><br><a href=\"https://nodes.wlan-si.net/nodes/node/" + node.pk +"/\">more information</a>";
